...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=DEV\\SQLEXPRESS; initial catalog=CIPlatform;Trusted_Connection=True;TrustServerCertificate=True");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.AdminId).HasName("PK__admin__43AA41417D0E4570");
        ...
        {
            entity.HasKey(e => e.BannerId).HasName("PK__banner__10373C3407A865B2");
        ...
        {
            entity.HasKey(e => e.CityId).HasName("PK__city__031491A8A3148935");
            ...
            entity.HasOne(d => d.Country).WithMany(p => p.Cities)
                ...
                .HasConstraintName("FK__city__country_id__489AC854");
        });

        modelBuilder.Entity<CmsPage>(entity =>
        {
            entity.HasKey(e => e.CmsPageId).HasName("PK__cms_page__B46D5B52468C8C0B");
        ...
        {
            entity.HasKey(e => e.CommentId).HasName("PK__comment__E7957687427210C9");
            ...
            entity.HasOne(d => d.Mission).WithMany(p => p.Comments)
                ...
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__comment__mission__498EEC8D");
        ...
        {
            entity.HasKey(e => e.CountryId).HasName("PK__country__7E8CD0559227B430");
        ...
        {
            entity.HasKey(e => e.FavouriteMissionId).HasName("PK__favorite__94E4D8CA0F33750A");
            ...
            entity.HasOne(d => d.Mission).WithMany(p => p.FavoriteMissions)
                .HasForeignKey(d => d.MissionId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__favorite___missi__4B7734FF");
        ...
        {
            entity.HasKey(e => e.GoalMissionId).HasName("PK__goal_mis__358E02C75B705695");
            ...
            entity.HasOne(d => d.Mission).WithMany(p => p.GoalMissions)
                .HasForeignKey(d => d.MissionId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__goal_miss__missi__4D5F7D71");
        });

        modelBuilder.Entity<Mission>(entity =>
        {
            entity.HasKey(e => e.MissionId).HasName("PK__mission__B5419AB26E7F4F36");
            ...
            entity.Property(e => e.Title)
                ...
                .IsUnicode(false)
                .HasColumnName("title");
            entity.Property(e => e.ToatalSeats).HasColumnName("toatal_seats");
            entity.Property(e => e.UpdatedAt)
                .HasColumnType("datetime")
                .HasColumnName("updated_at");
        });
        ...
        {
            entity.HasKey(e => e.MissionApplicationId).HasName("PK__mission___DF92838AF7BADE7B");
            ...
            entity.HasOne(d => d.Mission).WithMany(p => p.MissionApplications)
                .HasForeignKey(d => d.MissionId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__mission_a__missi__4E53A1AA");
        ...
        {
            entity.HasKey(e => e.MissionDocumentId).HasName("PK__mission___E80E0CC8B3C8705A");
            ...
            entity.HasOne(d => d.Mission).WithMany(p => p.MissionDocuments)
                .HasForeignKey(d => d.MissionId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__mission_d__missi__503BEA1C");
        });

        modelBuilder.Entity<MissionInvite>(entity =>
        {
            entity.HasKey(e => e.MissionInviteId).HasName("PK__mission___A97ED15838CDF9DD");
            ...
            entity.HasOne(d => d.Mission).WithMany(p => p.MissionInvites)
                .HasForeignKey(d => d.MissionId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__mission_i__missi__51300E55");
        ...
        {
            entity.HasKey(e => e.MissionMediaId).HasName("PK__mission___848A78E85C579BA8");
            ...
            entity.HasOne(d => d.Mission).WithMany(p => p.MissionMedia)
                .HasForeignKey(d => d.MissionId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__mission_m__missi__540C7B00");
        });

        modelBuilder.Entity<MissionRating>(entity =>
        {
            entity.HasKey(e => e.MissionRatingId).HasName("PK__mission___320E517263066B3F");
        ...
        {
            entity.HasKey(e => e.MissionSkillId).HasName("PK__mission___82712008CB0B6548");
        ...
        {
            entity.HasKey(e => e.MissionThemeId).HasName("PK__mission___4925C5AC8770FB18");
        ...
        {
            entity.HasKey(e => e.Email).HasName("PK__password__AB6E616508620E81");
        ...
        {
            entity.HasKey(e => e.SkillId).HasName("PK__skill__FBBA8379C8394AC3");
        ...
        {
            entity.HasKey(e => e.StoryId).HasName("PK__story__66339C567580A9DA");
            ...
            entity.HasOne(d => d.Mission).WithMany(p => p.Stories)
                .HasForeignKey(d => d.MissionId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__story__mission_i__58D1301D");
        ...
        {
            entity.HasKey(e => e.StoryInviteId).HasName("PK__story_in__04497867A39D2B65");
        ...
        {
            entity.HasKey(e => e.StoryMediaId).HasName("PK__story_me__29BD053C8BB34B16");
            ...
            entity.HasOne(d => d.Story).WithMany(p => p.StoryMedia)
                ...
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__story_med__story__5AB9788F");
        });

        modelBuilder.Entity<Timesheet>(entity =>
        {
            entity.HasKey(e => e.TimesheetId).HasName("PK__timeshee__7BBF5068D62F8AA0");
            ...
            entity.HasOne(d => d.Mission).WithMany(p => p.Timesheets)
                .HasForeignKey(d => d.MissionId)
                .HasConstraintName("FK__timesheet__missi__5BAD9CC8");
        ...
        {
            entity.HasKey(e => e.UserSkillId).HasName("PK__user_ski__FD3B576B927D152B");
